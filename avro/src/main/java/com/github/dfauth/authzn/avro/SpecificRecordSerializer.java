...
public abstract class SpecificRecordSerializer<T> implements Serializer<T> {
    ...
    public static class Builder {
        ...
        public <T> SpecificRecordSerializer<T> build() {
            ...
            return new ConfluentSpecificRecordSerializer(client, ImmutableMap.of(
